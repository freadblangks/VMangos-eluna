...
enum EUnitFields
{
    ...
    UNIT_FIELD_ATTACK_POWER = EObjectFields::OBJECT_END + 0xA1,                    // 0x0A7 - Size: 1 - Type: INT - Flags: PRIVATE + OWNER_ONLY
    ...
    UNIT_FIELD_RANGED_ATTACK_POWER = EObjectFields::OBJECT_END + 0xA5,             // 0x0AB - Size: 1 - Type: INT - Flags: PRIVATE + OWNER_ONLY
...
enum EPlayerFields
{
    ...
    PLAYER_FIELD_COMBO_TARGET = EUnitFields::UNIT_END + 0x9A,                      // 0x144 - Size: 2 - Type: GUID - Flags: PRIVATE
