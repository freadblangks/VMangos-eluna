...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_TRADINGRAIDLOOT_TIME,
    ...
    //Bot Summon Pet
    CONFIG_WARRIOR_BOT_SUMMON_PET,
    CONFIG_PALADIN_BOT_SUMMON_PET,
    CONFIG_HUNTER_BOT_SUMMON_PET,
    CONFIG_ROGUE_BOT_SUMMON_PET,
    CONFIG_PRIEST_BOT_SUMMON_PET,
    CONFIG_SHAMAN_BOT_SUMMON_PET,
    CONFIG_MAGE_BOT_SUMMON_PET,
    CONFIG_WARLOCK_BOT_SUMMON_PET,
    CONFIG_DRUID_BOT_SUMMON_PET,
    CONFIG_BOT_HUNTER_PET_LOSE_HAPPINESS,
    CONFIG_BOT_ENVIRONMENTAL_DAMAGE,
    ...
    CONFIG_HARDCORECHALLENGER_BAN_TRADE,
    CONFIG_HARDCORECHALLENGER_BAN_MAIL,
    CONFIG_HARDCORECHALLENGER_BAN_AUCTION,
